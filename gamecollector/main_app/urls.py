...
from .views import home, about, games_index, games_detail, add_playtime, assoc_platform, unassoc_platform, signup, GamesCreate, GamesUpdate, GamesDelete, add_photo
...
urlpatterns = [
    ...
    path('games/<int:games_id>/add_photo/', add_photo, name='add_photo'),
